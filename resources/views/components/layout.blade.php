...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="/bluntlogo.png">
  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">Bluntt</a></h4>
    ...
    <footer class="border-top text-center small text-muted py-3">
        <p class="m-0">Copyright &copy; {{date('Y')}} <a href="/" class="text-muted">Bluntt</a>. All rights reserved.</p>
      </footer>
    <style>
      footer {
        width: 100%;
